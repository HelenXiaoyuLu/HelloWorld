 ...
 j.output = load(fullfile(dirp, 'Wellbase_2PFieldStimIlastic 20200126 T_out'));
...
%             'DisplayName','Clump');    
    ...
    ax.XAxis.Label.String = 'Blue Intensity';
    ax.YAxis.Label.String = 'Red Intensity';
    ax.XAxis.Limits = [0,20000];
    ax.YAxis.Limits = [0,5000];
end
