...
%                                 'separation', 0.1);
    ...
    T_well.n_fov = splitapply(@numel, T_fov.FOV, wellgroups);
    ...
    T_group.Area = splitapply(@mean, T_well.Area, groupgroups);
    T_group.n_well = splitapply(@numel, T_well.Well, groupgroups);
    T_group.TraceRaw = splitapply(@mean, T_well.TraceRaw, T_well.Area, groupgroups);
    T_group.TraceDetrend = splitapply(@mean, T_well.TraceDetrend, T_well.Area, groupgroups);
    T_group.TraceFinal = splitapply(@mean, T_well.TraceFinal, T_well.Area, groupgroups);    
