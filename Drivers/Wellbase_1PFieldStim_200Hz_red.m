function [T_group, T_well, T_fov] = Wellbase_2PFieldStim_CorrFilter(cfg)
    % Wellbase_1PFieldStim is a pipeline main function. 
    % [T_group, T_well, T_fov] = Wellbase_1PFieldStim(cfg)
    % INPUT
    ...
    cfg.default = db.jobConfig(...
        'path', 'D:\OneDrive - rice.edu\Francois\RedGEVIs\Wet\Results\20190310-0318 Jun cp\20190308 Jun cp 200Hz', ...
        'tgtCh\path', '200Hz', ...
        'tgtCh\frame', 0, ...
        'tgtCh\sampleFrame', 0, ...
        'refCh\path', 'brightness', ...
        'refCh\ch', 2, ...
        'refCh\frame', 1, ...
        'stim', 'Dim2Bright Long-20180726-095811.ams4100',...
        'average', 0); % Default: no average 
    
%% Phase 1: Import Files and Settings
lib = sp.libData('2P FieldStim correlation filter');
...
lib.loadFrame(...
            ...
            'ncpu', Inf);
lib.loadFrame(...
            'path', cfg.getConfig('refCh\path'), ...
            'ch', cfg.getConfig('refCh\ch'), ...
            'f',1:8, ...
            'asch', 2, ...
            'ncpu', Inf);
lib.loadFOV();
