...
[~, locs] = findpeaks(Ismooth, "MinPeakDistance", 100000, 'MinPeakHeight', -5, 'MinPeakProminence', 15);
event_on = t_raw(locs);

%% Chop
spectra = [960, 800:40:1080, 960];
...
%%
save(fullfile('\\Stpierrelab7910\e\Images\Xiaoyu\20211018 KCR spectra\Results',...
