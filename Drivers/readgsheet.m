...
dtS = {'masked','Ratio of Mean Brightness (C2/C3)','-dFF0 of Mean (60V 1ms)',...
    '-dFF0 of Mean (30V 100ms)','Detectability index (60V 1ms)','Detectability index (30V 100ms)'};
libplot.scatterbylib(ScreeningC,'Detectability index (30V 100ms)',...
    'Detectability index (60V 1ms)','controls',{'JEDI2P'},'selectLib',{'JEDI2P'},...
    'datatip',dtS);
...
dtS = {'masked','Ratio of Mean Brightness (C2/C3)','-dFF0 of Mean (60V 1ms)',...
    '-dFF0 of Mean (30V 100ms)','Detectability index (60V 1ms)','Detectability index (30V 100ms)'};
libplot.scatterbylib(ScreeningO,'Detectability index (30V 100ms)',...
    'Detectability index (60V 1ms)','controls',{'JEDI1P'},...
    'datatip',dtS);
libplot.scatterbylib(ScreeningO,'-dFF0 of Mean (30V 100ms)','-dFF0 of Mean (60V 1ms)',...
    'controls',{'JEDI1P'},'datatip',dtS);
...
[TJ1all,meanJ2,~,F]=libplot.barplotall(ScreeningAll,'-dFF0 of Mean (30V 100ms)Norm2JEDI2P',...
    '1-dFF0 medianNorm2JEDI2P_Bleaching1Pstat','norm2ctrl',{'JEDI2P'},'controls',{'JEDI2P'},...
...
% 1ms bar plot ranked
[TJ1all,~,f11,f12,b1]=libplot.barplotall(ScreeningAll,...
...
[TJ100all,~,f21,f22,b2] = libplot.barplotall(TJ1all,'Ratio of Mean Brightness (C2/C3)Norm2JEDI2P',...
...
datacursormode on;
c2 = datacursormode(f22);
d2 = c2.createDatatip(b2);
xpos = d2.Position(1)
