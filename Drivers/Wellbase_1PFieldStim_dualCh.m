...
lib = libData('1P FieldStim');
lib.protocol.path = 'D:\OneDrive - rice.edu\Francois\ASAPScreening\Wet\Data\New_pipeline_for_Archive\20180312 ASAP1+2s-R406_100Hz';
lib.loadSet('path', 'TestSet', ...
            'ch',1, ...
            'f',1:5, ...
            'ncpu', Inf);
lib.loadSet('path', 'TestSet', ...
