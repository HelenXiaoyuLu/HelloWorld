...
elseif strcmpi(alpha, 'aa')
    ...
    colors(6,:) = {'Q', [0 1 0]};
    colors(7,:) = {'N', [0 1 0]};
    colors(8,:) = {'A', [0 0 0]}; % black
    colors(9,:) = {'V', [0 0 0]}; % black
    colors(10,:) = {'L', [0 0 0]}; % black
    colors(11,:) = {'I', [0 0 0]}; % black
    colors(12,:) = {'P', [1 165/255 0]};
    colors(13,:) = {'W', [1 165/255 0]}; 
    colors(14,:) = {'F', [1 165/255 0]}; 
    colors(15,:) = {'M', [1 165/255 0]};
    colors(16,:) = {'D', [1 0 0]}; % red
    colors(17,:) = {'E', [1 0 0]}; % red
    colors(18,:) = {'K', [0 0 1]}; % blue
    colors(19,:) = {'R', [0 0 1]}; % blue
    colors(20,:) = {'H', [0 0 1]}; % blue
